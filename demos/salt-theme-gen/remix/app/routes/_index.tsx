...
export const meta: MetaFunction = () => [{ title: 'salt-theme-gen — Remix' }];
  ...
  return (
    <main style={{ padding: 'var(--space-xl)' }}>
      <h1 style={{ fontSize: 'var(--text-xl)', marginBottom: 'var(--space-sm)', marginTop: 0 }}>
        salt-theme-gen — Remix
      </h1>
      <p style={{ color: 'var(--color-muted)', fontSize: 'var(--text-sm)', marginBottom: 'var(--space-lg)' }}>
        Preset: ocean &nbsp;·&nbsp; {mode} mode
      </p>

      <button onClick={toggle} style={{ background: 'var(--color-primary)', color: 'var(--color-on-primary)', border: 'none', padding: 'var(--space-sm) var(--space-md)', borderRadius: 'var(--radius-md)', cursor: 'pointer', fontSize: 'var(--text-sm)', marginBottom: 'var(--space-xl)' }}>
        Toggle dark mode
      </button>

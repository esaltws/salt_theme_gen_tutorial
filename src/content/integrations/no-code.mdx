...
stackblitz: https://stackblitz.com/edit/salt-theme-gen-vanilla
---
...
Run the generation script from the Framer section above, or use the [Vanilla JS online demo](https://stackblitz.com/edit/salt-theme-gen-vanilla) to generate and copy the CSS.
